...
<table border="1">
   ...
   <?php
    ...
    <td><a href="personaEstablecerEstadoEstrella.php?id= <?=$persona->getId()?>"> <img src='<?=$urlImagen?>' width='16' height='16'></a></td>
...
<a href="CategoriaListado2.php">Gestionar listado de Categorias</a>
